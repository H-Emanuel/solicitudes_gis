...
export function inicializarFormHeader() {
    ...
    console.log("La función inicializarFormHeader() ha sido llamada.");
    ...
    if (desc) {
        console.log("Aplicando estilo de fuente al subtítulo:", estilosPreguntaPreview.subtitulo.fontSize); 
        ...
        Object.assign(desc.style, {
            ...
            fontSize: estilosPreguntaPreview.subtitulo.fontSize || '16px'
        });
    }
    actualizarToolbarVisual('titulo');
    actualizarToolbarVisual('subtitulo');
    ...
    document.querySelectorAll('.toolbar-mini').forEach(toolbar => {
        ...
        const fontSizeSelect = toolbar.querySelector('.toolbar-font-size');
        if (fontSizeSelect) {
            console.log("Cambio de tamaño de fuente detectado:", fontSizeSelect.value); 
